...
void OS_Init(void){
  ...
  BSP_Clock_InitFastest();// set processor clock to fastest speed
	OS_FIFO_Init();
  periodic_Counter = 0;// perform any initializations needed
}
...
int OS_AddPeriodicEventThread(void(*thread)(void), uint32_t period){
	switch(periodic_Counter){
		case 0: BSP_PeriodicTask_Init(thread,(1000.0/period),2); periodic_Counter++; return 1;
		break;
		case 1: BSP_PeriodicTask_InitB(thread,(1000.0/period),3); periodic_Counter++; return 1;
		break;
		case 2: BSP_PeriodicTask_InitC(thread,(1000.0/period),4); periodic_Counter++; return 1;
		break;
		default: return 0;
		break;
	}
